            ...
            <form className="portrait:block overflow-hidden text-m p-2 w-full h-4/5 items-center justify-center flex flex-col">
              <div className="name-div flex m-1 flex-row items-center justify-center w-full">
                ...
                <input
                  ...
                  type="text"
                  className="name rounded  bg-gray-200 p-1 w-11/12 h-8"
                />
              </div>
              <div className="username-div flex flex-col items-center justify-center w-full m-1">
                ...
                <input
                  ...
                  type="text"
                  className="username username-input rounded  bg-gray-200 p-1 w-11/12 h-8"
                />
              </div>
              <div className="email-div flex flex-row items-center justify-center w-full m-1">
                ...
                <input
                  ...
                  type="email"
                  className="email rounded  bg-gray-200 p-1 w-11/12 h-8"
                />
              </div>
              ...
              <div className="password-div flex flex-row justify-center w-full m-1">
                ...
                <input
                  ...
                  type="password"
                  className="password rounded  bg-gray-200 p-1 w-11/12 h-8 overflow-hidden"
                />
              </div>
              <div className="flex flex-col h-36 items-center justify-center w-full">
                <div className="w-full h-full flex flex-row items-center justify-center">
                  <label
                    htmlFor="image"
                    className=" w-3/3 h-6 overflow-hidden bg-orange-500 rounded text-white p-1 flex items-center justify-center"
                  >
              ...
              <div className="flex flex-col items-center w-full justify-center m-1">
                {loader ? (
                  ...
                  <input
                    ...
                    className="overflow-hidden cursor-pointer submit-btn shadow-2xl w-24 h-8 border-3 p-1 rounded text-white bg-orange-500 border"
                    value="Register"
                  />
                )}
              </div>

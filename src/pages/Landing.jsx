            ...
            <div className="main w-full mt- flex flex-col items-center  h-fit">
                    ...
                    <div className="w-1/2">
                        ...
                        <div className="grid grid-cols-2">
                            <div className="flex items-center justify-start m-3 w-1/2">
                                <i className="bi-arrow-right-circle hover:scale-110" style={{ "font-size": "2rem", "color": "orange" }}></i>
                                <p className="ml-4 text-lg font-semibold mt-2 mb-0">Discover Music</p>
                            </div>
                            <div className="flex items-center justify-start m-3 w-1/2">
                                <i className="bi-arrow-right-circle hover:scale-110" style={{ "font-size": "2rem", "color": "orange" }}></i>
                                <p className="ml-4 text-lg font-semibold mt-2 mb-0">Discover Music</p>
                            ...
                            <div className="flex items-center justify-start m-3 w-1/2">
                                <i className="bi-arrow-right-circle hover:scale-110" style={{ "font-size": "2rem", "color": "orange" }}></i>
                                <p className="ml-4 text-lg font-semibold mt-2 mb-0">mTunes Concert</p>
                            </div>
                            <div className="flex items-center justify-start m-3 w-1/2">
                                <i className="bi-arrow-right-circle hover:scale-110" style={{ "font-size": "2rem", "color": "orange" }}></i>
                                <p className="ml-4 text-lg font-semibold mt-2 mb-0">Friend Activity</p>
                            </div>
                            <div className="flex items-center justify-start m-3 w-1/2">
                                <i className="bi-arrow-right-circle hover:scale-110" style={{ "font-size": "2rem", "color": "orange" }}></i>
                                <p className="ml-4 text-lg font-semibold mt-2 mb-0">Sharing Music</p>
                            </div>
                            <div className="flex items-center justify-start m-3 w-1/2">
                                <i className="bi-arrow-right-circle hover:scale-110" style={{ "font-size": "2rem", "color": "orange" }}></i>
                                <p className="ml-4 text-lg font-semibold mt-2 mb-0">Daily Mixes</p>
                            </div>
                            <div className="flex items-center justify-start m-3 w-1/2">
                                <i className="bi-arrow-right-circle hover:scale-110" style={{ "font-size": "2rem", "color": "orange" }}></i>
                                <p className="ml-4 text-lg font-semibold mt-2 mb-0">Create Playlists</p>
                            </div>
                            <div className="flex items-center justify-start m-3 w-1/2">
                                <i className="bi-arrow-right-circle hover:scale-110" style={{ "font-size": "2rem", "color": "orange" }}></i>
                                <p className="ml-4 text-lg font-semibold mt-2 mb-0">Private Sessions</p>
                            </div>
                        </div>
                ...
                <div className="flex w-full h-fit justify-around items-center">
                    ...
                    <div className="mt-16 w-1/3 grid items-center  grid-cols-2">
                        <img className="bg-blue-600 m-4 hover:brightness-75" src={require("./../images/partner-1.png")} alt="" />
                        <img className="bg-blue-600 m-4 hover:brightness-75" src={require("./../images/partner-1.png")} alt="" />
                        <img className="bg-blue-600 m-4 hover:brightness-75" src={require("./../images/partner-1.png")} alt="" />
                        <img className="bg-blue-600 m-4 hover:brightness-75" src={require("./../images/partner-1.png")} alt="" />
                    </div>
                    ...
                    <div className="flex items-center w-1/2">
                        <div className="flex flex-col relative w-1/3 items-center mt-8  justify-center p-4  bg-gray-800 text-white border-4 border-white rounded-xl">
                            ...
                            <ul className="m-0 p-0 mb-4 w-2/3 flex items-center justify-start flex-col">
                                <li className="flex items-center justify-start w-full text-xl mt-4"><i className="mr-1 bi-music-note"></i>Discover music</li>
                                <li className="flex items-center justify-start w-full text-xl mt-4"><i className="mr-1 bi-music-note"></i>Create Playlist</li>
                                <li className="text-gray-600 flex items-center justify-start w-full text-xl mt-4"><i className="mr-1 bi-music-note"></i>Share Music</li>
                                <li className="text-gray-600 flex items-center justify-start w-full text-xl mt-4"><i className="mr-1 bi-music-note"></i>Private Sessions</li>
                            </ul>
                        ...
                        <div className="flex flex-col relative w-1/3 items-center mt-8  justify-center p-4 bg-gray-800 text-white border-4 border-white rounded-xl">
                            ...
                            <ul className="m-0 p-0 mb-4 w-2/3 flex items-center justify-start flex-col">
                                <li className="flex items-center justify-start w-full text-xl mt-4"><i className="mr-1 bi-music-note"></i>Discover music</li>
                                <li className="flex items-center justify-start w-full text-xl mt-4"><i className="mr-1 bi-music-note"></i>Create Playlist</li>
                                <li className="flex items-center justify-start w-full text-xl mt-4"><i className="mr-1 bi-music-note"></i>Share Music</li>
                                <li className="text-gray-600 flex items-center justify-start w-full text-xl mt-4"><i className="mr-1 bi-music-note"></i>Private Sessions</li>
                            </ul>
                        ...
                        <div className="flex flex-col relative w-1/3 items-center mt-8  justify-center p-4 bg-gray-800 text-white border-4 border-white rounded-xl">
                            ...
                            <ul className="m-0 p-0 mb-4 w-2/3 flex items-center justify-start flex-col">
                                ...
                                <li className="flex items-center justify-start w-full text-xl mt-4"><i className="mr-1 bi-music-note"></i>Create Playlist</li>
                                <li className=" flex items-center justify-start w-full text-xl mt-4"><i className="mr-1 bi-music-note"></i>Share Music</li>
                                <li className=" flex items-center justify-start w-full text-xl mt-4"><i className="mr-1 bi-music-note"></i>Private Sessions</li>
                            </ul>
                ...
                <div className="footer text-white flex items-center justify-center p-6 mt-8 bg-gray-800 w-full">
                    ...
                    <div className="flex flex-col items-center justify-center w-2/12">
                        ...
                        <div className="bg-yellow-200 flex items-center justify-between w-full rounded-lg">

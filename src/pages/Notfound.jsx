    ...
    return (
        <div className='w-full h-screen p-4'>
            <div className="lost h-1/3 w-2/3 shadow-2xl m-auto flex flex-col items-center justify-center">
                <div className="lost  text-2xl text-red-500 font-bold ml-auto mr-auto flex flex-col items-center justify-center">
                    404
                    <i className='bx bxs-moon m-5'></i>
                </div>
                <div className="lost ml-auto mr-auto flex flex-row items-center justify-center">
